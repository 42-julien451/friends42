...
#		['', '', '', '', '', '', '', 'x', '', '', '', '', '', 'x', '', '', '', '', '', '', 'd'],
#	],
    "allowed": ['bess-f2', 'bess-f3', 'bess-f4', 'paul-f3', 'paul-f4', 'paul-f5'],
	"buildings": {'bess': ['bess-f2', 'bess-f3', 'bess-f4'], 'paul': ['paul-f3', 'paul-f4', 'paul-f5']},
	"kiosk_classes": {
		"<i class='fa-brands fa-apple'></i>": ['bess-f3', 'paul-f3'],
		"<i class='fa-solid fa-display'></i>": ['bess-f2', 'bess-f4', 'paul-f4', 'paul-f5'],
	},
	"piscine": [],
	"default": 'bess-f2',
	"exrypz": exrypz
